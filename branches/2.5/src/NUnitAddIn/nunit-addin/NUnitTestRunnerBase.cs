...
namespace NUnit.AddInRunner
{
    ...
    public abstract class NUnitTestRunnerBase : ITestRunner
    {
        ...
        interface IRun
        {
            TestRunState Run(NUnitTestRunnerBase testRunner, ITestListener testListener, Assembly assembly);
        }

        class AssemblyRun : IRun
        {
            public TestRunState Run(NUnitTestRunnerBase testRunner, ITestListener testListener, Assembly assembly)
            {
