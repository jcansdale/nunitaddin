namespace NUnit.AddInRunner
{
    ...
    public class NUnitTestRunner : ITestRunner
    {
        ...
        class NamespaceRun : IRun
        {
            ...
            public TestRunState Run(NUnitTestRunner testRunner, ITestListener testListener, Assembly assembly)
            {
                TestFilter filter = new NamespaceFilter(assembly, ns);
                filter = testRunner.addCategoriesFilter(filter);
        ...
        {
            TestFilter filter = new MethodFilter(assembly, method);
        ...
        {
            TestFilter filter = new TypeFilter(assembly, type);
            filter = addCategoriesFilter(filter);
        ...
        TestFilter addCategoriesFilter(TestFilter filter)
        {
        ...
        TestRunState run(ITestListener testListener, Assembly assembly, TestFilter filter)
        {
            ...
            */
            ...
            NUnit.Core.ITestListener listener = new ProxyEventListener(testListener, totalTestCases);
        ...
        class ProxyEventListener : NUnit.Core.ITestListener
        {
